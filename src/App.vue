    ...
    <div class="grid md:grid-cols-2 gap-4">
      ...
      <div class="space-y-3">
        <div>
          ...
          <pre class="mt-1 w-full border rounded p-3 bg-white overflow-auto text-sm" style="max-height: 300px;">{{ prettyResult }}</pre>
        </div>
        ...
        <div>
          ...
          <pre class="mt-1 w-full border rounded p-3 bg-white overflow-auto text-sm" style="max-height: 260px;">{{ mswText }}</pre>
        </div>
      </div>
    </div>
  </main>
